...
// 해당 슬롯의 가장 최근 status_board 레코드 조회
export async function GET(
  ...
  try {
    ...
    const { data, error } = await supabase
      .from('status_board')
      .select('id, room_number, girl_name, start_time, usage_duration, is_designated, event_count, trigger_type, is_in_progress')
      .eq('slot_id', slotId)
