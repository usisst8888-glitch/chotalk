      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="bg-gray-800 rounded-2xl border border-gray-700 p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-white">인원 추가하기</h2>
          </div>
        ...
        <section className="bg-gray-800 rounded-2xl border border-gray-700 p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-white">인원 관리하기</h2>
          </div>
          <div className="space-y-4 text-gray-300">
            ...
            <div className="flex items-start gap-3">
              ...
              <p>인원 기간을 연장합니다. 계좌번호 안내가 표시됩니다.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-800 rounded-2xl border border-gray-700 p-6 mb-6">
          ...
          <div className="space-y-3 text-gray-300">
            <p>각 인원에 표시된 <span className="text-indigo-400 font-semibold">초대할 ID</span>를 복사하여 카카오톡 채팅방에 초대하세요.</p>
        ...
        <section className="bg-gray-800 rounded-2xl border border-gray-700 p-6 mb-6">
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="flex items-center gap-3">
              ...
              <p>만료된 인원은 빨간색으로 표시됩니다. 연장이 필요합니다.</p>
            </div>
          </div>
        </section>
