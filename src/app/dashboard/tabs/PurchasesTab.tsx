...
interface PurchasesTabProps {
  purchaseRequests: Array<{ id: string; username: string; depositor_name: string; slot_count: number; total_amount: number; created_at: string }>;
  purchasesLoading: boolean;
  handleApprovePurchase: (requestId: string) => void;
}
